        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="text-align: right;">
                    <a href="{{url('admin/homework/homework/add')}}" class="btn btn-primary mb-0">Add New Homework</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form method="get">
                            ...
                            <div class="row align-items-center justify-content-center">
                                        ...
                                        <button class="btn btn-primary mb-2">Search </button>
                                            <a href="{{url('admin/homework/homework')}}" class="btn btn-danger mb-2">Reset</a>
                                        </div>
                                    </div>
                        </form>
                    </div>
