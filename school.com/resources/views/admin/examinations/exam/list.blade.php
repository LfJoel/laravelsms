    ...
    <form method="get">
                <div class="card-body">
                    ...
                    <div class="col-auto">
                        ...
                        <input type="text" name="note" value="{{ Request::get('note')}}" class="form-control mb-2"  placeholder="Note">
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <a href="{{url('admin/examinations/exam/list')}}" class="btn btn-danger mb-2">Reset</a>
                    </div>
                    </div>
