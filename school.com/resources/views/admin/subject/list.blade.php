        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="text-align: right;">
                    <a href="{{url('admin/subject/add')}}" class="btn btn-primary mb-0">Add New Subject</a>
                </div>
            </div>
            <!--end::Row-->
        </div>
                    ...
                    <form method="get">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <button class="btn btn-primary mb-2">Search Subject</button>
                                </div>
                                <div class="col-auto">
                                    <a href="{{url('admin/subject/list')}}" class="btn btn-danger mb-2">Reset</a>
                                </div>
                            </div>
