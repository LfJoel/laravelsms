                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="text-danger">{{ $errors->first('fevicon_icon') }}</div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Small Sidebar Logo</label>
                                        <input type="file" name="small_logo" class="form-control">
                                        <div class="text-danger">{{ $errors->first('small_logo') }}</div>
                                        @if (!empty($getRecord->getSmallLogo()))
                                            <img src="{{ $getRecord->getSmallLogo() }}" alt="" style="width:100px;">
                                        @endif
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Paypal Business Email address</label>
                                        <input type="email" name="paypal_email" class="form-control"
                                            aria-describedby="emailHelp" value="{{ $getRecord->paypal_email }}"
